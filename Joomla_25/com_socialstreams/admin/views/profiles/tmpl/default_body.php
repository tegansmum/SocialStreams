...
//    $item->cat_link = JRoute::_('index.php?option=com_categories&extension=com_visitmanager&task=edit&type=other&cid[]=' . $item->catid);
    ...
    <tr class="row<?php echo $i % 2; ?>">
        ...
        <td>
            <a href="<?php echo JRoute::_('index.php?option=com_socialstreams&task=profile.edit&id=' . (int) $item->id); ?>">
        ...
        <td class="center">
            <a href="<?php echo $this->escape($item->url); ?>"><img src="<?php echo $item->image; ?>" /></a>
        </td>
